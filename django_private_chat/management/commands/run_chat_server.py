...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        asyncio.async(handlers.gone_online_handler(channels.gone_online))
        asyncio.async(handlers.check_online_handler(channels.check_online))
        asyncio.async(handlers.gone_offline_handler(channels.gone_offline))
        ...
        asyncio.async(handlers.unread_msg_count_handler(channels.unread_msg_count))
